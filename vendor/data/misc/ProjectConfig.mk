...
CUSTOM_HAL_ANT = mt6853_ant_m1
CUSTOM_HAL_AUDIOFLINGER = audio
#ifdef VENDOR_EDIT
#Henry.Chang@Camera.Driver, 2018/11/30 add for sfr hidl to sdcard.
MTK_CAM_CAM_DUMP_SUPPORT = yes
#endif
CUSTOM_HAL_CAMERA = camera
CUSTOM_HAL_CAM_CAL = BRCB032GWZ_3 GT24c32a cat24c16
CUSTOM_HAL_COMBO = mt6853
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5kgm1st_mipi_raw ov16a10_mipi_raw s5k3p9sp_mipi_raw hi846_mipi_raw gc02k_mipi_raw ov02b1b_mipi_raw s5kgw3_mipi_raw athensb_ov32a1q_mipi_raw athensb_hi846_mipi_raw athensb_gc02k_mipi_raw athensb_gc02m1b_mipi_raw cake_ov13b10_mipi_raw cake_s5k4h7_mipi_raw cake_gc02m1b_mipi_mono cake_gc02k0_mipi_raw athensc_s5kgm1st_mipi_raw athensc_imx471_mipi_raw athensc_hi846_mipi_raw athensd_hi846_mipi_raw athensd_imx471_mipi_raw athensd_s5kgw3_mipi_raw athensd_s5kgw3_mipi_raw_new athensd_gc02k_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = hi846_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = ov16a10_mipi_raw s5kgw3_mipi_raw cake_ov13b10_mipi_raw
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p9sp_mipi_raw
...
#ifdef VENDOR_EDIT
#tangjh@PSW.BSP.sensor,2019/11/10, add sensor
CUSTOM_KERNEL_LUX_AOD_SENSOR=yes
CUSTOM_KERNEL_FREE_FALL_SENSOR=yes
CUSTOM_KERNEL_PICKUP_MOTION_SENSOR=yes
CUSTOM_KERNEL_ACTION_DETECT_SENSOR=yes
CUSTOM_KERNEL_FFD_SENSOR=yes
...
CUSTOM_KERNEL_IMGSENSOR = s5kgm1st_mipi_raw ov16a10_mipi_raw s5k3p9sp_mipi_raw hi846_mipi_raw gc02k_mipi_raw ov02b1b_mipi_raw s5kgw3_mipi_raw athensb_ov32a1q_mipi_raw athensb_hi846_mipi_raw athensb_gc02k_mipi_raw athensb_gc02m1b_mipi_raw cake_ov13b10_mipi_raw cake_s5k4h7_mipi_raw cake_gc02m1b_mipi_mono cake_gc02k0_mipi_raw athensc_s5kgm1st_mipi_raw athensc_imx471_mipi_raw athensc_hi846_mipi_raw athensd_hi846_mipi_raw athensd_imx471_mipi_raw athensd_s5kgw3_mipi_raw athensd_s5kgw3_mipi_raw_new athensd_gc02k_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LINEARACCEL_SENSOR = no
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = hi846_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov16a10_mipi_raw s5kgw3_mipi_raw cake_ov13b10_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p9sp_mipi_raw
...
#ifdef VENDOR_EDIT
#Li.Chen@CONNECTIVITY.BT.A2DP. 2949582. 2020/04/26,
#Support LHDC codec
...
#endif
#ifdef VENDOR_EDIT
#Xiaomin.Yang@PSW.CN.BT.Basic.Customize.1586611, 2018/10/20, Add for enabling IOT list load from local file.
MTK_BT_INTEROP_LIST_TC16 = yes
#endif /* VENDOR_EDIT */
#ifndef VENDOR_EDIT
#Kun.Du@PSW.CN.BT.Basic.Customize.1056939, 2020/04/20, Add for disabling SAP profile.
...
#Yi.Yang@PSW.AD.Performace, 2019/10/14  Add for disable duraspeed feature
...
#ifdef VENDOR_EDIT
#Qilong.Ao@PSW.AD.OppoLog.0, 2020/04/22, Modify for yes
...
#ifdef VENDOR_EDIT
#Zequan.Wang@PSW.AD.BuildConfig.0, 2017/12/17, Modify for not used
...
#ifndef VENDOR_EDIT
#Liu.Jie@MM.Display.DS.OSIE, 2020/05/06, Modify for OSIE
...
#ifdef VENDOR_EDIT
#zhouyang@PSW.NW.REG, 2019/10/22, 2435809 , Modify SIM_CARD_ONOFF:
#MTK_SIM_CARD_ONOFF=1 is for default config by MTK
#MTK_SIM_CARD_ONOFF=2 is for modified config by OPPO
MTK_SIM_CARD_ONOFF = 2
#endif /*VENDOR_EDIT*/
MTK_SIM_HOT_SWAP = yes
#ifdef VENDOR_EDIT
#chenyihuai@PSW.NW.REG, 2020/04/22, Modify HOT_SIM
#mt6873 6885 is yes
...
##ifndef VENDOR_EDIT
#Dingshan.Yang@PSW.NW.REG.2491401, 2019/10/28
#modify for more log print, should revert when pvt
...
SYSTEM_AS_ROOT = yes
#ifdef VENDOR_EDIT
#yang.tan@PSW.BSP.Fingerprint 2019/10/02
...
#Yongzhi.Zhang@PSW.MM.AudioDriver.Feature.1611397, 2019/03/26, add for voice scence
AUDIO_VOICE_SCENCE_OPPO = yes
MTK_CONSYS_EFEM_SUPPORT = no
MTK_NEBULA_VM_SUPPORT = no
MTK_SCLTM_SUPPORT = yes

#Jianqing.Liao@PSW.MM.AudioDriver, 2020/01/17,Add for sixth
OPPO_SIA_DSP_SUPPORT = yes
MTK_APUSYS_RT_SUPPORT = yes
#ifdef VENDOR_EDIT
#gongqiang.xiao@camera,2020/08/22,config mfll to 10 frames
MTK_CAM_MFB_MAX_FRAME = 10
#endif /* VENDOR_EDIT */
MTK_CAPABILITY_CONTROL_SUPPORT = yes
MTK_NWK_OPT_SUPPORT = no
MTK_PAPE = 1

#Meilin.Zhou@BSP.Fingerprint.Basic, 2020/07/30, add foradd for secure vedio.
MTK_TEE_GP_SUPPORT = yes
#endif/* VENDOR_EDI T*/

#Jianqing.Liao@PSW.MM.AudioDriver, 2020/05/12,Add for Speaker force mute
OPPO_SPEAKER_FORCE_MUTE = yes
#Hefeng.Wu@RM.MM.AudioDriver.feature, 2020/06/11
OPPO_KTV_V2 = yes
#Jianqing.Liao@PSW.MM.AudioDriver, 2020/06/01,Add for swap mic record
OPPO_DUALMIC_SWAP_RECORD = yes
#Jianqing.Liao@PSW.MM.AudioDriver, 2020/07/27,Add for lvimfs record
OPLUS_FEATURE_LVIMFS_SUPPORT =yes

#ifdef VENDOR_EDIT
#Wenhua.Leng@PSW.MM.Display.DS, 2019/09/23, Add for GiFT
